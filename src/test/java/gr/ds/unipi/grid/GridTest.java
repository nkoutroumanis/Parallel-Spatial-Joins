...
public class GridTest {
    ...
    public void newGrid() {
        ...
        System.out.println("a1:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 10))+ " a11:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 10)));
        System.out.println("a2:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 19))+ " a12:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 19)));
        System.out.println("a3:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 25))+ " a13:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 25)));
        System.out.println("a4:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 31))+ " a14:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 31)));
        System.out.println("a5:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 40))+ " a15:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 40)));
        System.out.println("a6:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 60))+ " a16:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 60)));
        System.out.println("a7:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 69))+ " a17:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 69)));
        System.out.println("a8:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 75))+ " a18:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 75)));
        System.out.println("a9:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 81))+ " a19:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 81)));
        System.out.println("a10:"+Arrays.toString(grid.getPartitionsATypeInExecutor(40, 90))+ " a20:"+Arrays.toString(grid.getPartitionsATypeInExecutor(60, 90)));

        System.out.println();
        System.out.println("b1:"+Arrays.toString(grid.getPartitionsATypeInExecutor(25, 25))+ " b5:"+Arrays.toString(grid.getPartitionsATypeInExecutor(75, 25)));
        System.out.println("b2:"+Arrays.toString(grid.getPartitionsATypeInExecutor(25, 45))+ " b6:"+Arrays.toString(grid.getPartitionsATypeInExecutor(75, 45)));
        System.out.println("b3:"+Arrays.toString(grid.getPartitionsATypeInExecutor(25, 55))+ " b7:"+Arrays.toString(grid.getPartitionsATypeInExecutor(75, 55)));
        System.out.println("b4:"+Arrays.toString(grid.getPartitionsATypeInExecutor(25, 75))+ " b8:"+Arrays.toString(grid.getPartitionsATypeInExecutor(75, 75)));
