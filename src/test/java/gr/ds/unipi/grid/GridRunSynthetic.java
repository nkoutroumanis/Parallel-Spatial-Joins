...
public class GridRunSynthetic {
    ...
    public void newGrid() throws IOException {
        ...
        List<Map.Entry<String, Map.Entry<Functions, String>>> s = Arrays.asList(new Map.Entry[]{new AbstractMap.SimpleEntry("/Users/nicholaskoutroumanis/Desktop/joins/costs/universalA.txt", new AbstractMap.SimpleEntry(Functions.datasetA, "")), new AbstractMap.SimpleEntry("/Users/nicholaskoutroumanis/Desktop/joins/costs/universalB.txt", new AbstractMap.SimpleEntry(Functions.datasetB, "")),
                new AbstractMap.SimpleEntry("/Users/nicholaskoutroumanis/Desktop/joins/costs/DEFAULT.txt", new AbstractMap.SimpleEntry(Functions.dok, "")), new AbstractMap.SimpleEntry("/Users/nicholaskoutroumanis/Desktop/joins/costs/DIAGONAL_ONLY.txt", new AbstractMap.SimpleEntry(Functions.dok, "DIAG_ONLY")),
                new AbstractMap.SimpleEntry("/Users/nicholaskoutroumanis/Desktop/joins/costs/DIAGONAL_COMPLIANT.txt", new AbstractMap.SimpleEntry(Functions.dok, "DIAG_COMP")), new AbstractMap.SimpleEntry("/Users/nicholaskoutroumanis/Desktop/joins/costs/DIAGONAL_PRIORITY.txt", new AbstractMap.SimpleEntry(Functions.dok, "DIAG_PR")),
        });

        DecimalFormat decf = new DecimalFormat("0.000");

        for (Map.Entry<String, Map.Entry<Functions, String>> entry : s) {
            ...
            for (int r = 1; r <= 200; r = r + 5) {
                ...
                Grid grid = Grid.newGrid(Rectangle.newRectangle(Point.newPoint(0, 0), Point.newPoint(100, 100)), r1, (TriFunction<Cell, Cell, Point, Agreement>) entry.getValue().getKey());

                String line = null;

                String pathDatasetA = "/Users/nicholaskoutroumanis/Desktop/joins/initial/datasetA.csv";
                String pathDatasetB = "/Users/nicholaskoutroumanis/Desktop/joins/initial/datasetB.csv";
                ...
                w.write(String.format("%-18s",r1) + String.format("%-18s", grid.getCellsInXAxis() + "X" + grid.getCellsInYAxis()) + String.format("%-18s",replication) + sb);
                w.newLine();
