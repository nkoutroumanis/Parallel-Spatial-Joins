...
public class GridTimeDistSTEP {
    ...
    public static void main(String args[]) {
        ...
        df1 = df1.withColumn("partitions", functions$.MODULE$.explode(functions$.MODULE$.col("partitions"))).persist(StorageLevel.MEMORY_ONLY());
        df2 = df2.withColumn("partitions", functions$.MODULE$.explode(functions$.MODULE$.col("partitions"))).persist(StorageLevel.MEMORY_ONLY());
        ...
        df1= df1.repartition(functions$.MODULE$.col("partitions")).persist(StorageLevel.MEMORY_ONLY());
        df2= df2.repartition(functions$.MODULE$.col("partitions")).persist(StorageLevel.MEMORY_ONLY());
