...
public class GridTimeDistRealsTuple10 {
...
//            EpsilonGrid grid = EpsilonGrid.newGrid(Rectangle.newRectangle(Point.newPoint(0, 0), Point.newPoint(100, 100)), radius);
            ...
            JavaRDD<Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> rddTuplesA = rddTxtFilesA.map((String line) -> {
                String[] elements = line.split("\t");
                return new Tuple13<>(elements[0], Double.parseDouble(elements[1]), Double.parseDouble(elements[2]), randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000);
            });

            JavaRDD<Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> rddTuplesB = rddTxtFilesB.map((String line) -> {
                String[] elements = line.split("\t");
                return new Tuple13<>(elements[0], Double.parseDouble(elements[1]), Double.parseDouble(elements[2]), randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000);
            });
            ...
            JavaPairRDD<Integer, Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> pairRDDA = rddTuplesA.flatMapToPair(new PairFlatMapFunction<Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Integer, Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>() {
                @Override
            ...
            JavaPairRDD<Integer, Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> pairRDDB = rddTuplesB.flatMapToPair(new PairFlatMapFunction<Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Integer, Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>() {
                @Override
                public Iterator<Tuple2<Integer, Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> call(Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double> tuple) throws Exception {
                    List<Tuple2<Integer, Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> list = new ArrayList<>();
            ...
            JavaPairRDD<Integer, Tuple2<Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> joinedRDD = pairRDDA.join(pairRDDB, new HashPartitioner(Integer.parseInt(args[4])));
