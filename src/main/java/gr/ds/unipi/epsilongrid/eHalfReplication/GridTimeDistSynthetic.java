...
public class GridTimeDistSynthetic {
...
//            EpsilonGrid grid = EpsilonGrid.newGrid(Rectangle.newRectangle(Point.newPoint(0, 0), Point.newPoint(100, 100)), radius);
            ...
            long count = joinedRDD.filter((t) -> {
                double xMean = (t._2._1._2() + t._2._2._2())/2;
                double yMean = (t._2._1._3() - t._2._2._3())/2;

                if (Math.pow((t._2._1._2() - t._2._2._2()), 2) + Math.pow((t._2._1._3() - t._2._2._3()), 2) <= Math.pow(radius, 2) && gridBroadcasted.getValue().getCellId(xMean, yMean)==t._1) {
                    return true;
                } else {
                    return false;
                }
