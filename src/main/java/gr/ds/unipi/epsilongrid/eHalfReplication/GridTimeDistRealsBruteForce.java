...
public class GridTimeDistRealsBruteForce {
                 ...
                 public Iterator<Tuple2<Tuple3<String, Double, Double>,Tuple3<String, Double, Double>>> call(Tuple2<Integer, Tuple2<Iterable<Tuple3<String, Double, Double>>, Iterable<Tuple3<String, Double, Double>>>> tup) throws Exception {
                    ...
                    for (Tuple3<String, Double, Double> objectA : objectsA) {
                        for (Tuple3<String, Double, Double> objectB : objectsB) {
                            double xMean = (objectA._2()+objectB._2())/2;
                            double yMean = (objectA._3()+objectB._3())/2;

                            if((Math.pow((objectA._2() - objectB._2()), 2) + Math.pow((objectA._3()- objectB._3()), 2) <= Math.pow(radius, 2)) && gridBroadcasted.getValue().getCellId(xMean, yMean)==tup._1){
...
//            }).toDebugString());
        ...
        FileWriter fw = new FileWriter("./timeExec-"+args[2]+"-"+args[3]+"-"+args[1]+"-epsilonHalf-bf.txt", true);
