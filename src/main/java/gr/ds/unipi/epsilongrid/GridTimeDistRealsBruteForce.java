...
//                    int objectsASize=0, int objectsBSize=0;
...
//                    }
                    ...
                    Algorithms.bruteForce(/*objectsA*/tup._2()._1,/*objectsB*/tup._2()._2,results,radius);
...
//            }).toDebugString());
        ...
        FileWriter fw = new FileWriter("./timeExec-"+args[2]+"-"+args[3]+"-"+args[1]+"-epsilon-bf.txt", true);
