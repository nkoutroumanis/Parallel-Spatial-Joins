...
//class Functions {
//
//    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> datasetA = (i1, i2, c1, c2) -> {
//        return gr.ds.unipi.agreements.Agreement.newAgreement(gr.ds.unipi.agreements.Edge.newEdge(i1, i2, TypeSet.A, 0), gr.ds.unipi.agreements.Edge.newEdge(i2, i1, TypeSet.A, 0));
//    };
//
//    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> datasetB = (i1, i2, c1, c2) -> {
//        return gr.ds.unipi.agreements.Agreement.newAgreement(gr.ds.unipi.agreements.Edge.newEdge(i1, i2, TypeSet.B, 0), gr.ds.unipi.agreements.Edge.newEdge(i2, i1, TypeSet.B, 0));
//    };
//
////    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> bestCase = (i1, i2, c1, c2) -> {
...
////
////        if(a <= b){
////            return gr.ds.unipi.agreements.Agreement.newAgreement(gr.ds.unipi.agreements.Edge.newEdge(i1, i2, TypeSet.A, a1 * c2.getNumberOfPointsBType()), gr.ds.unipi.agreements.Edge.newEdge(i2, i1, TypeSet.A, a1 * c1.getNumberOfPointsBType()));
////        }else{
////            return gr.ds.unipi.agreements.Agreement.newAgreement(gr.ds.unipi.agreements.Edge.newEdge(i1, i2, TypeSet.B, b1 * c2.getNumberOfPointsAType()), gr.ds.unipi.agreements.Edge.newEdge(i2, i1, TypeSet.B, b1 * c1.getNumberOfPointsAType()));
////        }
////    };
//
//    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> worstCase = (i1, i2, c1, c2) -> {
//        long a1 = c1.getNumberOfPointsAType() + c2.getNumberOfPointsAType();
//        long b1 = c1.getNumberOfPointsBType() + c2.getNumberOfPointsBType();
//
//        long a2 = Math.abs(c1.getNumberOfPointsAType() - c2.getNumberOfPointsAType());
...
//    };
//
//    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> case1 = (i1, i2, c1, c2) -> {
//
//        long c1A = 0;
//        long c2A = 0;
//        long c1B = 0;
...
//            return gr.ds.unipi.agreements.Agreement.newAgreement(gr.ds.unipi.agreements.Edge.newEdge(i1, i2, TypeSet.A, c2AgreementA), gr.ds.unipi.agreements.Edge.newEdge(i2, i1, TypeSet.A, c1AgreementA));
//        }else if((c1AgreementA+c2AgreementA)>(c1AgreementB+c2AgreementB)){
//            return gr.ds.unipi.agreements.Agreement.newAgreement(gr.ds.unipi.agreements.Edge.newEdge(i1, i2, TypeSet.B, c2AgreementB), gr.ds.unipi.agreements.Edge.newEdge(i2, i1, TypeSet.B, c1AgreementB));
//        }else{
...
//    };
//
//    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> actualCaseVariation2 = (i1, i2, c1, c2) -> {
//
//        long c1A = 0;
//        long c2A = 0;
//        long c1B = 0;
...
//    };
//
//    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> MYCASE = (i1, i2, c1, c2) -> {
//
//        long c1A = 0;
//        long c2A = 0;
//        long c1B = 0;
...
//    };
//
//    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> actualCaseVariation4 = (i1, i2, c1, c2) -> {
//
//        long c1A = 0;
//        long c2A = 0;
//        long c1B = 0;
...
//    };
//
////    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> actualCaseWithMemory = (i1, i2, c1, c2) -> {
////
////        long c1A = 0;
////        long c2A = 0;
////        long c1B = 0;
...
////            long c2AgreementB = (c2.getNumberOfPointsBType() + c2.getExtraNumberOfPointsBType()) * c2.getNumberOfPointsAType();
////
////            return Agreement.newAgreement(gr.ds.unipi.agreements.Edge.newEdge(i1, i2, TypeSet.B, c2AgreementB), Edge.newEdge(c2, c1, TypeSet.B, c1AgreementB));
////        }
////    };
////
////    static Function6<Integer, Integer, Cell, Cell, Agreement> trial = (i1, i2, c1, c2) -> {
////
////        long c1A = 0;
////        long c2A = 0;
////        long c1B = 0;
...
//
//
//    //static Function6<Integer, Integer, Cell, Cell, Agreement> function;
//
////    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> dokimastiko = (i1, i2, c1, c2) -> {
////
////        long c1A = 0;
////        long c2A = 0;
////        long c1B = 0;
...
//////                return gr.ds.unipi.agreements.Agreement.newAgreement(gr.ds.unipi.agreements.Edge.newEdge(i1, i2, TypeSet.A, c2AgreementAA), gr.ds.unipi.agreements.Edge.newEdge(i2, i1, TypeSet.A, c1AgreementAA));
//////            }else{
//////                return gr.ds.unipi.agreements.Agreement.newAgreement(gr.ds.unipi.agreements.Edge.newEdge(i1, i2, TypeSet.B, c2AgreementBB), gr.ds.unipi.agreements.Edge.newEdge(i2, i1, TypeSet.B, c1AgreementBB));
//////
//////            }
//////        }else{
...
//
//
//    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> unini = (i1, i2, c1, c2) -> {
//
//        long c1A = 0;
//        long c2A = 0;
//        long c1B = 0;
...
//    };
//
//    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> dok = (i1, i2, c1, c2) -> {
//
//        long c1A = 0;
//        long c2A = 0;
//        long c1B = 0;
...
//
//    };
////    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> trial = (i1, i2, c1, c2) -> {
////
////        long c1A = 0;
////        long c2A = 0;
////        long c1B = 0;
...
////    };
//
////    static Function6<Integer, Integer, Cell, Cell, gr.ds.unipi.agreements.Agreement> another = (i1, i2, c1, c2) -> {
////
////        long c1A = 0;
////        long c2A = 0;
////        long c1B = 0;
