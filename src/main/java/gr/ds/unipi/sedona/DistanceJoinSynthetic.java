...
public class DistanceJoinSynthetic {
...
//        Map$.MODULE$.apply(null);
            ...
            PointRDD objectRDDA = new PointRDD(jsc, path + args[2] + ".csv", 1, FileDataSplitter.SEMICOLON, true);
            PointRDD objectRDDB = new PointRDD(jsc, path + args[3] + ".csv", 1, FileDataSplitter.SEMICOLON, true);
...
//            objectRDDA.analyze(envelope, 200000000);
            objectRDDB.analyze(envelope, 100000000);
...
//        objectRDDB.analyze();
            ...
            circleRDD.analyze(envelope,100000000);
//        circleRDD.analyze();
