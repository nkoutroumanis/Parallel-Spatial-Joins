...
public class GridTimeRealsPrunedTuple10 {
...
//            };
            ...
            JavaPairRDD<Integer, Tuple2<Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Tuple13<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> joinedRDD = pairRDDA.join(pairRDDB, cp);
