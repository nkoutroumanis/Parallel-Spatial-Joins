package gr.ds.unipi.rdd.tuples;
...
public class GridTimeRealsPrunedTuple18 {
...
//        rddTxtFilesB = rddTxtFilesB.union(rddTxtFilesB).union(rddTxtFilesB);
            ...
            JavaRDD<Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> rddTuplesA = rddTxtFilesA.map((String line) -> {
                String[] elements = line.split("\t");
                return new Tuple21<>(elements[0], Double.parseDouble(elements[1]), Double.parseDouble(elements[2]), randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000);
            });

            JavaRDD<Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> rddTuplesB = rddTxtFilesB.map((String line) -> {
                String[] elements = line.split("\t");
                return new Tuple21<>(elements[0], Double.parseDouble(elements[1]), Double.parseDouble(elements[2]), randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000);
            });
...
//        }
            ...
            JavaPairRDD<Integer, Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> pairRDDA = rddTuplesA.flatMapToPair(new PairFlatMapFunction<Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Integer, Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>() {
                @Override
                public Iterator<Tuple2<Integer, Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> call(Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double> tuple) throws Exception {
                    List<Tuple2<Integer, Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> list = new ArrayList<>();
            ...
            JavaPairRDD<Integer, Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> pairRDDB = rddTuplesB.flatMapToPair(new PairFlatMapFunction<Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Integer, Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>() {
                @Override
                public Iterator<Tuple2<Integer, Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> call(Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double> tuple) throws Exception {
                    List<Tuple2<Integer, Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> list = new ArrayList<>();
                    int[] cellIds = null;
...
//            };
            ...
            JavaPairRDD<Integer, Tuple2<Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Tuple21<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> joinedRDD = pairRDDA.join(pairRDDB, cp);
