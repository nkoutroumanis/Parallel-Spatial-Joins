...
public class GridTimeRealsPrunedTuple16 {
...
//        rddTxtFilesB = rddTxtFilesB.union(rddTxtFilesB).union(rddTxtFilesB);
            ...
            JavaRDD<Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> rddTuplesA = rddTxtFilesA.map((String line) -> {
                String[] elements = line.split("\t");
                return new Tuple19<>(elements[0], Double.parseDouble(elements[1]), Double.parseDouble(elements[2]), randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000);
            });

            JavaRDD<Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> rddTuplesB = rddTxtFilesB.map((String line) -> {
                String[] elements = line.split("\t");
                return new Tuple19<>(elements[0], Double.parseDouble(elements[1]), Double.parseDouble(elements[2]), randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000);
            });
...
//        }
            ...
            JavaPairRDD<Integer, Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> pairRDDA = rddTuplesA.flatMapToPair(new PairFlatMapFunction<Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Integer, Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>() {
                @Override
                public Iterator<Tuple2<Integer, Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> call(Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double> tuple) throws Exception {
                    List<Tuple2<Integer, Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> list = new ArrayList<>();
            ...
            JavaPairRDD<Integer, Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>> pairRDDB = rddTuplesB.flatMapToPair(new PairFlatMapFunction<Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Integer, Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>() {
                @Override
                public Iterator<Tuple2<Integer, Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> call(Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double> tuple) throws Exception {
                    List<Tuple2<Integer, Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> list = new ArrayList<>();
                    int[] cellIds = null;
...
//            };
            ...
            JavaPairRDD<Integer, Tuple2<Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>, Tuple19<String, Double, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double, String, Double>>> joinedRDD = pairRDDA.join(pairRDDB, cp);
