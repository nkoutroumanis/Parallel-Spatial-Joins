...
public class GridTimeRealsPrunedTuple6PostProcessing {
...
//            };
            ...
            JavaPairRDD<String, Tuple9<String, Double, Double, String, Double, String, Double, String, Double>> pairRddTuplesAFat = rddTxtFilesA.mapToPair((String line) -> {
                String[] elements = line.split(";");
                return new Tuple2<>(elements[0], new Tuple9<>(elements[0], Double.parseDouble(elements[1]), Double.parseDouble(elements[2]), randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000));
            });

            JavaPairRDD<String, Tuple9<String, Double, Double, String, Double, String, Double, String, Double>> pairRddTuplesBFat = rddTxtFilesB.mapToPair((String line) -> {
                String[] elements = line.split(";");
                return new Tuple2<>(elements[0], new Tuple9<>(elements[0], Double.parseDouble(elements[1]), Double.parseDouble(elements[2]), randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000, randomString(random, 8), random.nextDouble()*1000000));
            });

            long count = joinedRDD.mapToPair(tuple-> new Tuple2<>(tuple._2._1._1(), tuple._2._2._1())).join(pairRddTuplesAFat, new HashPartitioner(384)).mapToPair(tuple-> new Tuple2<>(tuple._2._2._1(), tuple._2._2)).join(pairRddTuplesBFat, new HashPartitioner(384)).count();
