...
public class GridTimeRealsPrunedTuple8 {
...
//            };
            ...
            JavaPairRDD<Integer, Tuple2<Tuple11<String, Double, Double, String, Double, String, Double, String, Double, String, Double>, Tuple11<String, Double, Double, String, Double, String, Double, String, Double, String, Double>>> joinedRDD = pairRDDA.join(pairRDDB, cp);
