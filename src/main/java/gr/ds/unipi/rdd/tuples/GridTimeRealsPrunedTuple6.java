...
public class GridTimeRealsPrunedTuple6 {
...
//            };
            ...
            JavaPairRDD<Integer, Tuple2<Tuple9<String, Double, Double, String, Double, String, Double, String, Double>, Tuple9<String, Double, Double, String, Double, String, Double, String, Double>>> joinedRDD = pairRDDA.join(pairRDDB, cp);
