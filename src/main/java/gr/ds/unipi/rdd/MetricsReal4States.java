...
public class MetricsReal4States {
    ...
    public static void main(String args[]) throws IOException {
        ...
        SparkConf sparkConf = new SparkConf().set("spark.serializer","org.apache.spark.serializer.KryoSerializer").set("spark.kryo.registrationRequired", "true")
                .registerKryoClasses(new Class[]{Grid.class, Agreement.class, Agreements.class, Edge.class, Edge[].class,  Space.class, Cell.class, NewFunc.class, Position.class, TypeSet.class, java.util.HashMap.class, Point.class, Rectangle.class, ArrayList.class, java.lang.invoke.SerializedLambda.class, org.apache.spark.util.collection.CompactBuffer[].class, org.apache.spark.util.collection.CompactBuffer.class, scala.reflect.ManifestFactory$.class,scala.reflect.ManifestFactory$.MODULE$.Any().getClass(), ConcurrentHashMap.class, UnsafeHashedRelation.class});
        ...
        Grid grid = Grid.newGeoGrid(Rectangle.newRectangle(Point.newPoint(-124.409591, 31.332177), Point.newPoint(-109.041060, 42.009520)), radius, function);
        ...
        if(!(flag == 1 || flag ==2)) {
            ...
            sampleTuples = rddTuplesA.sample(false, 0.02,261).collect();
            ...
            sampleTuples = rddTuplesB.sample(false, 0.02,261).collect();
