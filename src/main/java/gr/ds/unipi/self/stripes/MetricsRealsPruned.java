package gr.ds.unipi.self.stripes;
...
public class MetricsRealsPruned {
    ...
    public static void main(String args[]) throws IOException {
        ...
        UserDefinedFunction udfCoordinatesToArray = udf(
                (String x, String y) -> gridBroadcasted.getValue().getPartitionsInExecutor(Double.parseDouble(x), Double.parseDouble(y)), DataTypes.createArrayType(DataTypes.IntegerType)
        );

        UserDefinedFunction udfCoordinatesToHomeId = udf(
                (String x, String y) -> gridBroadcasted.getValue().getPartitionsInExecutor(Double.parseDouble(x), Double.parseDouble(y)), DataTypes.IntegerType
        );
