...
//        return neighbors.containsKey(cellHash);
    ...
    public void addNeighboor(int cellHash){
//        neighbors.put(cellHash, typeset);
    }

    public void addExtraNumberOfPointsType(int numberOfPoints){
        totalNumberOfPointsType = totalNumberOfPointsType + numberOfPoints;
    }
