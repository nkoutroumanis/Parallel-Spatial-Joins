...
public class GridTimeRealsPrunedCorrectnessPlaneSweepNewEdition {
...
//                    for (int i = 0; i < replicatedObjectsList.size()-1; i++) {
//                        for (int j = i+1; j < replicatedObjectsList.size(); j++) {
//                            Algorithms.planeSweep(replicatedObjectsList.get(i), replicatedObjectsList.get(j), results, radius);
//                        }
//                    }
...
//                            homeObjects.add(obj);
//                        }else{
//                            if(replicatedObjectsMap.containsKey(cellId)){
//                                replicatedObjectsMap.get(cellId).add(obj);
//                            }else{
//                                List<Tuple3<String,Double,Double>> replList = new ArrayList<>();
//                                replList.add(obj);
//                                replicatedObjectsMap.put(cellId, replList);
//                            }
//                        }
////                        }else{
