...
public class MetricsRealsPrunedEpsilon {

    public static void main(String args[]) throws IOException {

        BufferedWriter w = new BufferedWriter(new FileWriter("./metrics-"+args[2] + "-"+args[1]+"-"+"mrdsj-e"+".txt"));
        ...
        GenericMRDSJGrid grid = GenericMRDSJGrid.newGenericGrid(Rectangle.newRectangle(Point.newPoint(-124.763068, 17.673976), Point.newPoint(-64.564909, 49.384360)), radius, 1, Integer.parseInt(args[3]));
