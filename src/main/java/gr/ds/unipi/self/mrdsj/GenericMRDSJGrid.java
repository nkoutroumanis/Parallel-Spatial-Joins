...
public class GenericMRDSJGrid {
    ...
    public static GenericMRDSJGrid newGenericGrid(Rectangle rectangle, double r, int side, int c){
        ...
        return new GenericMRDSJGrid(rectangle, (int) cellsInXAxis, (int) cellsInYAxis, r, side, c);
    }
    private GenericMRDSJGrid(Rectangle rectangle, int cellsInXAxis, int cellsInYAxis, double r, int side, int c){
        ...
        if(c<1 || c>4){
            try {
                throw new Exception("c should be not lower than than 1 and not higher than 4");
            } catch (Exception e) {
                e.printStackTrace();
            }        }
        this.c = c;
    ...
    public int[] getPartitions(double x, double y){
        ...
        switch(c){
            ...
            case 2:
                ...
                if(hasLeft(cellId) && hasTop(cellId) && isInTopLeftQuarterArea(rectangle,x,y,r)){
                    cells.add(cellId + cellsInXAxis -1);
                }
                if(hasTop(cellId) && isInTopSpecialArea(rectangle,y,r)){
                    cells.add(cellId + cellsInXAxis);
            ...
            case 3:
                ...
                if(hasLeft(cellId) && hasBottom(cellId) && isInBottomLeftQuarterArea(rectangle,x,y,r)){
                    cells.add(cellId - cellsInXAxis -1);
                }
            ...
            case 4:
                ...
                if(hasRight(cellId) && hasBottom(cellId) && isInBottomRightQuarterArea(rectangle,x,y,r)){
                    cells.add(cellId - cellsInXAxis +1);
                }
                if(hasBottom(cellId) && isInBottomSpecialArea(rectangle,y,r)){
                    cells.add(cellId - cellsInXAxis);
